                ...
                children: [
                  CachedNetworkImage(
                    ...
                    errorWidget: (_, __, ___) => const Center(
                      child: Icon(Icons.image_not_supported, color: AppColors.slate400, size: 48),
                    ),
                  ),
                  if (product.isOnSale)
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(color: AppColors.rose500.withValues(alpha: 0.4), blurRadius: 8),
                          ],
                        ),
                        child: const Row(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 15, color: AppColors.slate900),
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      Text('${product.rating}', style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w500)),
                      Text(' (${product.reviews.toString().replaceAllMapped(RegExp(r'(\d)(?=(\d{3})+(?!\d))'), (m) => '${m[1]},')})',
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          padding: const EdgeInsets.all(10),
                          decoration: BoxDecoration(
                            color: isInCart ? AppColors.emerald500 : AppColors.accent,
  ...
  Widget _buildPrice() {
    if (product.isOnSale && product.originalPrice != null) {
      return Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('${formatPrice(product.originalPrice!)}원',
    ...
    return Text('${formatPrice(product.price)}원',
